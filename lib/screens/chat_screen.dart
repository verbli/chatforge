...
class _ChatSettingsDialogState extends ConsumerState<_ChatSettingsDialog> {
  ...
  Widget _buildContextSettings() {
    ...
    if (model == null) {
      return const Text('Please select a model first');
    }
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: '<${model.capabilities.maxContextTokens}',
                ),
                keyboardType: TextInputType.number,
                onChanged: (value) {
                  ...
                  if (tokens != null) {
                    setState(() {
                      _settings = _settings.copyWith(
                        maxContextTokens: tokens.clamp(0, model.capabilities.maxContextTokens),
                      );
                    });
                  }
                },
